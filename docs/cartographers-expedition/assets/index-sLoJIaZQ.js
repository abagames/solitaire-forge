...
`;function J(e,l){return new PIXI.Filter(void 0,V,{width:e,height:l})}const $=new o;let H,W,U,B=new o;const de=5;document.createElement("img");let Y,fe,Qe=1,Zl="black",se,Vt,Be=!1,X,Wt;function un(e,l,i,n,a,f,C,k){$.set(e),X=k,Zl=i;const P=`
...
`;if(document.body.style.cssText=P,B.set($),X.isUsingPixi){B.mul(de);const E=new PIXI.Application({width:B.x,height:B.y});if(H=E.view,U=new PIXI.Graphics,U.scale.x=U.scale.y=de,PIXI.settings.SCALE_MODE=PIXI.SCALE_MODES.NEAREST,E.stage.addChild(U),U.filters=[],X.name==="crt"&&U.filters.push(Wt=new PIXI.filters.CRTFilter({vignettingAlpha:.7})),X.name==="pixel"&&U.filters.push(J(B.x,B.y)),X.name==="pixel"||X.name==="shapeDark"){const _=new PIXI.filters.AdvancedBloomFilter({threshold:.1,bloomScale:X.name==="pixel"?1.5:1,brightness:X.name==="pixel"?1.5:1,blur:8});U.filters.push(_)}U.lineStyle(0),H.style.cssText=O}else H=document.createElement("canvas"),H.width=B.x,H.height=B.y,W=H.getContext("2d"),W.imageSmoothingEnabled=!1,H.style.cssText=O+N;document.body.appendChild(H);const j=()=>{const _=innerWidth/innerHeight,Q=B.x/B.y,Z=_<Q,ie=Z?.95*innerWidth:.95*innerHeight*Q,te=Z?.95*innerWidth/Q:.95*innerHeight;H.style.width=`${ie}px`,H.style.height=`${te}px`};if(window.addEventListener("resize",j),j(),n){Y=document.createElement("canvas");let E;a?(Y.width=B.x,Y.height=B.y,E=f):(B.x<=B.y*2?(Y.width=B.y*2,Y.height=B.y):(Y.width=B.x,Y.height=B.x/2),Y.width>400&&(Qe=400/Y.width,Y.width=400,Y.height*=Qe),E=Math.round(400/Y.width)),fe=Y.getContext("2d"),fe.fillStyle=l,gcc.setOptions({scale:E,capturingFps:60,isSmoothingEnabled:!1,durationSec:C})}}function yl(){if(X.isUsingPixi){U.clear(),U.beginFill(I(Zl,X.isDarkColor?.15:1)),U.drawRect(0,0,$.x,$.y),U.endFill(),U.beginFill(I(se)),Be=!0;return}W.fillStyle=L(Zl,X.isDarkColor?.15:1),W.fillRect(0,0,$.x,$.y),W.fillStyle=L(se)}function me(e){if(e===se){X.isUsingPixi&&!Be&&wl(I(se));return}if(se=e,X.isUsingPixi){Be&&U.endFill(),wl(I(se));return}W.fillStyle=L(e)}function wl(e){xl(),U.beginFill(e),Be=!0}function xl(){Be&&(U.endFill(),Be=!1)}function vl(){Vt=se}function Cl(){me(Vt)}function _e(e,l,i,n){if(X.isUsingPixi){X.name==="shape"||X.name==="shapeDark"?U.drawRoundedRect(e,l,i,n,2):U.drawRect(e,l,i,n);return}W.fillRect(e,l,i,n)}function dn(e,l,i,n,a){const f=I(se);wl(f),U.drawCircle(e,l,a*.5),U.drawCircle(i,n,a*.5),xl(),U.lineStyle(a,f),U.moveTo(e,l),U.lineTo(i,n),U.lineStyle(0)}function fn(){Wt.time+=.2}function hn(){if(fe.fillRect(0,0,Y.width,Y.height),Qe===1)fe.drawImage(H,(Y.width-H.width)/2,(Y.height-H.height)/2);else{const e=H.width*Qe,l=H.height*Qe;fe.drawImage(H,(Y.width-e)/2,(Y.height-l)/2,e,l)}gcc.capture(Y)}const Yt=[`
l
l
l
...
`];let He,Sl;function pn(){He=[],Sl=[]}function Qt(){He=He.concat(Sl),Sl=[]}function Zt(e){let l={isColliding:{rect:{},text:{},char:{}}};return He.forEach(i=>{mn(e,i)&&(l=Object.assign(Object.assign(Object.assign({},l),et(i.collision.isColliding.rect)),{isColliding:{rect:Object.assign(Object.assign({},l.isColliding.rect),i.collision.isColliding.rect),text:Object.assign(Object.assign({},l.isColliding.text),i.collision.isColliding.text),char:Object.assign(Object.assign({},l.isColliding.char),i.collision.isColliding.char)}}))}),l}function mn(e,l){const i=l.pos.x-e.pos.x,n=l.pos.y-e.pos.y;return-l.size.x<i&&i<e.size.x&&-l.size.y<n&&n<e.size.y}function et(e){if(e==null)return{};const l={transparent:"tr",white:"wh",red:"rd",green:"gr",yellow:"yl",blue:"bl",purple:"pr",cyan:"cy",black:"lc"};let i={};return s(e).forEach(([n,a])=>{const f=l[n];a&&f!=null&&(i[f]=!0)}),i}function ei(e,l,i,n){return li(!1,e,l,i,n)}function yn(e,l,i,n){return li(!0,e,l,i,n)}function li(e,l,i,n,a){if(typeof i=="number"){if(typeof n=="number")return ke(l,i,n,Object.assign({isCharacter:e,isCheckingCollision:!0,color:se},a));throw"invalid params"}else return ke(l,i.x,i.y,Object.assign({isCharacter:e,isCheckingCollision:!0,color:se},n))}const Ze=6,wn=4,ye=1,ee=Ze*ye,Ge=wn*ye;let lt,tt,bl,it,nt=!1,Xe,st,el,kl;const rt={color:"black",backgroundColor:"transparent",rotation:0,mirror:{x:1,y:1},scale:{x:1,y:1},isSmallText:!1,edgeColor:void 0,isCharacter:!1,isCheckingCollision:!1};function xn(){Xe=document.createElement("canvas"),Xe.width=Xe.height=ee,st=Xe.getContext("2d"),el=document.createElement("canvas"),kl=el.getContext("2d"),lt=Yt.map((e,l)=>Pl(e,String.fromCharCode(33+l),!1)),tt=gn.map((e,l)=>Pl(e,String.fromCharCode(33+l),!1)),bl=Yt.map((e,l)=>Pl(e,String.fromCharCode(33+l),!0)),it={}}function vn(e,l){const i=l.charCodeAt(0)-33;e.forEach((n,a)=>{bl[i+a]=Pl(n,String.fromCharCode(33+i+a),!0)})}function Cn(){nt=!0}function ke(e,l,i,n={}){const a=ni(n);let f=e,C=l,k=i,P,O={isColliding:{rect:{},text:{},char:{}}};const N=a.isSmallText?Ge:ee;for(let j=0;j<f.length;j++){if(j===0){const Q=f.charCodeAt(0);if(Q<33||Q>126)C=Math.floor(C-ee/2*a.scale.x),k=Math.floor(k-ee/2*a.scale.y);else{const Z=Q-33,ie=a.isCharacter?bl[Z]:a.isSmallText?tt[Z]:lt[Z];C=Math.floor(C-ie.size.x/2*a.scale.x),k=Math.floor(k-ie.size.y/2*a.scale.y)}P=C}const E=f[j];if(E===`
`){C=P,k+=ee*a.scale.y;continue}const _=Sn(E,C,k,a);a.isCheckingCollision&&(O={isColliding:{rect:Object.assign(Object.assign({},O.isColliding.rect),_.isColliding.rect),text:Object.assign(Object.assign({},O.isColliding.text),_.isColliding.text),char:Object.assign(Object.assign({},O.isColliding.char),_.isColliding.char)}}),C+=N*a.scale.x}return O}function Sn(e,l,i,n){const a=e.charCodeAt(0);if(a<32||a>126)return{isColliding:{rect:{},text:{},char:{}}};const f=ni(n);if(f.backgroundColor!=="transparent"){const te=f.isSmallText?Ge:ee,Bl=f.isSmallText?2:1;vl(),me(f.backgroundColor),_e(l+Bl,i,te*f.scale.x,ee*f.scale.y),Cl()}if(a<=32)return{isColliding:{rect:{},text:{},char:{}}};const C=a-33,k=f.isCharacter?bl[C]:f.isSmallText?tt[C]:lt[C],P=r(f.rotation,0,4);if(f.color==="black"&&P===0&&f.mirror.x===1&&f.mirror.y===1&&f.edgeColor==null&&(!X.isUsingPixi||f.scale.x===1&&f.scale.y===1))return ot(k,l,i,f.scale,f.isCheckingCollision,!0);const O=JSON.stringify({c:e,options:f}),N=it[O];if(N!=null)return ot(N,l,i,f.scale,f.isCheckingCollision,f.color!=="transparent");let j=!1;const E=new o(ee,ee);let _=Xe,Q=st;if(k.size.x>ee||k.size.y>ee){if(P===0||P===2)E.set(k.size.x,k.size.y);else{const te=Math.max(k.size.x,k.size.y);E.set(te,te)}_=document.createElement("canvas"),_.width=E.x,_.height=E.y,Q=_.getContext("2d"),Q.imageSmoothingEnabled=!1}X.isUsingPixi&&(f.scale.x!==1||f.scale.y!==1)&&(el.width=E.x*f.scale.x,el.height=E.y*f.scale.y,kl.imageSmoothingEnabled=!1,kl.scale(f.scale.x,f.scale.y),ti(kl,P,f,k.image,E),j=!0),Q.clearRect(0,0,E.x,E.y),ti(Q,P,f,k.image,E);const Z=at(Q,E,e,f.isCharacter);f.edgeColor!=null&&(_=bn(Q,E,f.edgeColor),E.x+=2,E.y+=2);let ie;if(nt||X.isUsingPixi){const te=document.createElement("img");if(te.src=_.toDataURL(),X.isUsingPixi){const Bl=document.createElement("img");Bl.src=(j?el:_).toDataURL(),ie=PIXI.Texture.from(Bl)}nt&&(it[O]={image:te,texture:ie,hitBox:Z,size:E})}return ot({image:_,texture:ie,hitBox:Z,size:E},l,i,f.scale,f.isCheckingCollision,f.color!=="transparent")}function bn(e,l,i){const n=l.x+2,a=l.y+2,f=[[0,-1],[1,0],[0,1],[-1,0]],C=document.createElement("canvas");C.width=n,C.height=a;const k=C.getContext("2d");k.imageSmoothingEnabled=!1,k.drawImage(e.canvas,1,1);const O=k.getImageData(0,0,n,a).data;k.fillStyle=L(i);for(let N=0;N<a;N++)for(let j=0;j<n;j++){const E=(N*n+j)*4;if(O[E+3]===0)for(const[_,Q]of f){const Z=j+_,ie=N+Q;if(Z>=0&&Z<n&&ie>=0&&ie<a){const te=(ie*n+Z)*4;if(O[te+3]>0){k.fillRect(j,N,1,1);break}}}}return C}function ti(e,l,i,n,a){l===0&&i.mirror.x===1&&i.mirror.y===1?e.drawImage(n,0,0):(e.save(),e.translate(a.x/2,a.y/2),e.rotate(Math.PI/2*l),(i.mirror.x===-1||i.mirror.y===-1)&&e.scale(i.mirror.x,i.mirror.y),e.drawImage(n,-a.x/2,-a.y/2),e.restore()),i.color!=="black"&&(e.globalCompositeOperation="source-in",e.fillStyle=L(i.color==="transparent"?"black":i.color),e.fillRect(0,0,a.x,a.y),e.globalCompositeOperation="source-over")}function ot(e,l,i,n,a,f){if(f&&(n.x===1&&n.y===1?ii(e,l,i):ii(e,l,i,e.size.x*n.x,e.size.y*n.y)),!a)return;const C={pos:{x:l+e.hitBox.pos.x*n.x,y:i+e.hitBox.pos.y*n.y},size:{x:e.hitBox.size.x*n.x,y:e.hitBox.size.y*n.y},collision:e.hitBox.collision},k=Zt(C);return f&&He.push(C),k}function ii(e,l,i,n,a){if(X.isUsingPixi){xl(),U.beginTextureFill({texture:e.texture,matrix:new PIXI.Matrix().translate(l,i)}),U.drawRect(l,i,n??e.size.x,a??e.size.y),wl(I(se));return}n==null?W.drawImage(e.image,l,i):W.drawImage(e.image,l,i,n,a)}function Pl(e,l,i){if(e.indexOf(".")>=0||e.indexOf("data:image/")==0)return kn(e,l);let n=e.split(`
`);n=n.slice(1,n.length-1);let a=0;n.forEach(_=>{a=Math.max(_.length,a)});const f=Math.max(Math.ceil((Ze-a)/2),0),C=n.length,k=Math.max(Math.ceil((Ze-C)/2),0),P=new o(Math.max(Ze,a)*ye,Math.max(Ze,C)*ye);let O=Xe,N=st;(P.x>ee||P.y>ee)&&(O=document.createElement("canvas"),O.width=P.x,O.height=P.y,N=O.getContext("2d"),N.imageSmoothingEnabled=!1),N.clearRect(0,0,P.x,P.y),n.forEach((_,Q)=>{for(let Z=0;Z<a;Z++){const ie=_.charAt(Z);let te=m.indexOf(ie);ie!==""&&te>=1&&(N.fillStyle=L(c[te]),N.fillRect((Z+f)*ye,(Q+k)*ye,ye,ye))}});const j=document.createElement("img");j.src=O.toDataURL();const E=at(N,P,l,i);return X.isUsingPixi?{image:j,texture:PIXI.Texture.from(j),size:P,hitBox:E}:{image:j,size:P,hitBox:E}}function kn(e,l){const i=document.createElement("img");i.src=e;const n=new o,a={pos:new o,size:new o,collision:{isColliding:{char:{},text:{}}}};let f;return X.isUsingPixi?f={image:i,texture:PIXI.Texture.from(i),size:new o,hitBox:a}:f={image:i,size:n,hitBox:a},i.onload=()=>{f.size.set(i.width*ye,i.height*ye);const C=document.createElement("canvas");C.width=f.size.x,C.height=f.size.y;const k=C.getContext("2d");k.imageSmoothingEnabled=!1,k.drawImage(i,0,0,f.size.x,f.size.y);const P=document.createElement("img");P.src=C.toDataURL(),f.image=P,f.hitBox=at(k,f.size,l,!0),X.isUsingPixi&&(f.texture=PIXI.Texture.from(P))},f}function at(e,l,i,n){const a={pos:new o(ee,ee),size:new o,collision:{isColliding:{char:{},text:{}}}};n?a.collision.isColliding.char[i]=!0:a.collision.isColliding.text[i]=!0;const f=e.getImageData(0,0,l.x,l.y).data;let C=0;for(let k=0;k<l.y;k++)for(let P=0;P<l.x;P++)f[C+3]>0&&(P<a.pos.x&&(a.pos.x=P),k<a.pos.y&&(a.pos.y=k)),C+=4;C=0;for(let k=0;k<l.y;k++)for(let P=0;P<l.x;P++)f[C+3]>0&&(P>a.pos.x+a.size.x-1&&(a.size.x=P-a.pos.x+1),k>a.pos.y+a.size.y-1&&(a.size.y=k-a.pos.y+1)),C+=4;return a}function ni(e){let l=Object.assign(Object.assign({},rt),e);return e.scale!=null&&(l.scale=Object.assign(Object.assign({},rt.scale),e.scale)),e.mirror!=null&&(l.mirror=Object.assign(Object.assign({},rt.mirror),e.mirror)),l}let qe=!1,Rl=!1,ct=!1;const si=["Escape","Digit0","Digit1","Digit2","Digit3","Digit4","Digit5","Digit6","Digit7","Digit8","Digit9","Minus","Equal","Backspace","Tab","KeyQ","KeyW","KeyE","KeyR","KeyT","KeyY","KeyU","KeyI","KeyO","KeyP","BracketLeft","BracketRight","Enter","ControlLeft","KeyA","KeyS","KeyD","KeyF","KeyG","KeyH","KeyJ","KeyK","KeyL","Semicolon","Quote","Backquote","ShiftLeft","Backslash","KeyZ","KeyX","KeyC","KeyV","KeyB","KeyN","KeyM","Comma","Period","Slash","ShiftRight","NumpadMultiply","AltLeft","Space","CapsLock","F1","F2","F3","F4","F5","F6","F7","F8","F9","F10","Pause","ScrollLock","Numpad7","Numpad8","Numpad9","NumpadSubtract","Numpad4","Numpad5","Numpad6","NumpadAdd","Numpad1","Numpad2","Numpad3","Numpad0","NumpadDecimal","IntlBackslash","F11","F12","F13","F14","F15","F16","F17","F18","F19","F20","F21","F22","F23","F24","IntlYen","Undo","Paste","MediaTrackPrevious","Cut","Copy","MediaTrackNext","NumpadEnter","ControlRight","LaunchMail","AudioVolumeMute","MediaPlayPause","MediaStop","Eject","AudioVolumeDown","AudioVolumeUp","BrowserHome","NumpadDivide","PrintScreen","AltRight","Help","NumLock","Pause","Home","ArrowUp","PageUp","ArrowLeft","ArrowRight","End","ArrowDown","PageDown","Insert","Delete","OSLeft","OSRight","ContextMenu","BrowserSearch","BrowserFavorites","BrowserRefresh","BrowserStop","BrowserForward","BrowserBack"];let ut;const Pn={onKeyDown:void 0};let dt,ft=!1,ht=!1,gt=!1,pt={},mt={},yt={};function ri(e){dt=Object.assign(Object.assign({},Pn),e),ut=h(si.map(l=>[l,{isPressed:!1,isJustPressed:!1,isJustReleased:!1}])),document.addEventListener("keydown",l=>{ft=ht=!0,pt[l.code]=mt[l.code]=!0,dt.onKeyDown!=null&&dt.onKeyDown(),(l.code==="AltLeft"||l.code==="AltRight"||l.code==="ArrowRight"||l.code==="ArrowDown"||l.code==="ArrowLeft"||l.code==="ArrowUp")&&l.preventDefault()}),document.addEventListener("keyup",l=>{ft=!1,gt=!0,pt[l.code]=!1,yt[l.code]=!0})}function oi(){Rl=!qe&&ht,ct=qe&&gt,ht=gt=!1,qe=ft,s(ut).forEach(([e,l])=>{l.isJustPressed=!l.isPressed&&mt[e],l.isJustReleased=l.isPressed&&yt[e],l.isPressed=!!pt[e]}),mt={},yt={}}function ai(){Rl=!1,qe=!0}var Rn=Object.freeze({__proto__:null,get isPressed(){return qe},get isJustPressed(){return Rl},get isJustReleased(){return ct},codes:si,get code(){return ut},init:ri,update:oi,clearJustPressed:ai});class Ml{constructor(l=null){this.setSeed(l)}get(l=1,i){return i==null&&(i=l,l=0),this.next()/4294967295*(i-l)+l}getInt(l,i){i==null&&(i=l,l=0);const n=Math.floor(l),a=Math.floor(i);return a===n?n:this.next()%(a-n)+n}getPlusOrMinus(){return this.getInt(2)*2-1}select(l){return l[this.getInt(l.length)]}setSeed(l,i=123456789,n=362436069,a=521288629,f=32){this.w=l!=null?l>>>0:Math.floor(Math.random()*4294967295)>>>0,this.x=i>>>0,this.y=n>>>0,this.z=a>>>0;for(let C=0;C<f;C++)this.next();return this}getState(){return{x:this.x,y:this.y,z:this.z,w:this.w}}next(){const l=this.x^this.x<<11;return this.x=this.y,this.y=this.z,this.z=this.w,this.w=(this.w^this.w>>>19^(l^l>>>8))>>>0,this.w}}const ll=new o;let Pe=!1,Je=!1,tl=!1,Mn={isDebugMode:!1,anchor:new o,padding:new o,onPointerDownOrUp:void 0},re,he,ne;const il=new Ml,je=new o,Re=new o;let nl=!1,sl=new o,wt=!1,xt=!1,vt=!1;function ci(e,l,i){ne=Object.assign(Object.assign({},Mn),i),re=e,he=new o(l.x+ne.padding.x*2,l.y+ne.padding.y*2),sl.set(re.offsetLeft+re.clientWidth*(.5-ne.anchor.x),re.offsetTop+re.clientWidth*(.5-ne.anchor.y)),ne.isDebugMode&&je.set(re.offsetLeft+re.clientWidth*(.5-ne.anchor.x),re.offsetTop+re.clientWidth*(.5-ne.anchor.y)),document.addEventListener("mousedown",n=>{fi(n.pageX,n.pageY)}),document.addEventListener("touchstart",n=>{fi(n.touches[0].pageX,n.touches[0].pageY)}),document.addEventListener("mousemove",n=>{hi(n.pageX,n.pageY)}),document.addEventListener("touchmove",n=>{n.preventDefault(),hi(n.touches[0].pageX,n.touches[0].pageY)},{passive:!1}),document.addEventListener("mouseup",n=>{gi()}),document.addEventListener("touchend",n=>{n.preventDefault(),n.target.click(),gi()},{passive:!1})}function ui(){In(sl.x,sl.y,ll),ne.isDebugMode&&!ll.isInRect(0,0,he.x,he.y)?(Tn(),ll.set(je),Je=!Pe&&nl,tl=Pe&&!nl,Pe=nl):(Je=!Pe&&xt,tl=Pe&&vt,Pe=wt),xt=vt=!1}function di(){Je=!1,Pe=!0}function In(e,l,i){re!=null&&(i.x=Math.round(((e-re.offsetLeft)/re.clientWidth+ne.anchor.x)*he.x-ne.padding.x),i.y=Math.round(((l-re.offsetTop)/re.clientHeight+ne.anchor.y)*he.y-ne.padding.y))}function Tn(){Re.length>0?(je.add(Re),!x(je.x,-he.x*.1,he.x*1.1)&&je.x*Re.x>0&&(Re.x*=-1),!x(je.y,-he.y*.1,he.y*1.1)&&je.y*Re.y>0&&(Re.y*=-1),il.get()<.05&&Re.set(0)):il.get()<.1&&(Re.set(0),Re.addWithAngle(il.get(Math.PI*2),(he.x+he.y)*il.get(.01,.03))),il.get()<.05&&(nl=!nl)}function fi(e,l){sl.set(e,l),wt=xt=!0,ne.onPointerDownOrUp!=null&&ne.onPointerDownOrUp()}function hi(e,l){sl.set(e,l)}function gi(e){wt=!1,vt=!0,ne.onPointerDownOrUp!=null&&ne.onPointerDownOrUp()}var On=Object.freeze({__proto__:null,pos:ll,get isPressed(){return Pe},get isJustPressed(){return Je},get isJustReleased(){return tl},init:ci,update:ui,clearJustPressed:di});let Me=new o,Ie=!1,we=!1,Ae=!1;function pi(e){ri({onKeyDown:e}),ci(H,$,{onPointerDownOrUp:e,anchor:new o(.5,.5)})}function mi(){oi(),ui(),Me=ll,Ie=qe||Pe,we=Rl||Je,Ae=ct||tl}function yi(){ai(),di()}function rl(e){Me.set(e.pos),Ie=e.isPressed,we=e.isJustPressed,Ae=e.isJustReleased}var An=Object.freeze({__proto__:null,get pos(){return Me},get isPressed(){return Ie},get isJustPressed(){return we},get isJustReleased(){return Ae},init:pi,update:mi,clearJustPressed:yi,set:rl});let oe,ol,Ct=!1,wi,xi,St,Te={};function vi(e,l=1){const i=Te[e];return i==null?!1:(i.gainNode.gain.value=l,i.isPlaying=!0,!0)}function Dn(){const e=oe.currentTime;for(const l in Te){const i=Te[l];if(!i.isReady||!i.isPlaying)continue;i.isPlaying=!1;const n=Bn(e);(i.playedTime==null||n>i.playedTime)&&(Ln(i,n),i.playedTime=n)}}function Ci(e,l=void 0){const i=Te[e];i.source!=null&&(l==null?i.source.stop():i.source.stop(l),i.source=void 0)}function Fn(e=void 0){if(Te){for(const l in Te)Ci(l,e);Te={}}}function En(){oe=new(window.AudioContext||window.webkitAudioContext),document.addEventListener("visibilitychange",()=>{document.hidden?oe.suspend():oe.resume()})}function zn(){Ct=!0,ol=oe.createGain(),ol.connect(oe.destination),Si(),Un(),bi()}function jn(e,l){return Te[e]=$n(l),Te[e]}function Si(e=120){wi=e,xi=60/wi}function Un(e=8){St=e>0?4/e:void 0}function bi(e=.1){ol.gain.value=e}function Ln(e,l){const i=oe.createBufferSource();e.source=i,i.buffer=e.buffer,i.loop=e.isLooping,i.start=i.start||i.noteOn,i.connect(e.gainNode),i.start(l)}function $n(e){const l={buffer:void 0,source:void 0,gainNode:oe.createGain(),isPlaying:!1,playedTime:void 0,isReady:!1,isLooping:!1};return l.gainNode.connect(ol),Nn(e).then(i=>{l.buffer=i,l.isReady=!0}),l}async function Nn(e){const i=await(await fetch(e)).arrayBuffer();return await oe.decodeAudioData(i)}function Bn(e){if(St==null)return e;const l=xi*St;return l>0?Math.ceil(e/l)*l:e}let ki,Pi;const Ri=68,bt=1e3/Ri;let al=0;const _n={viewSize:{x:100,y:100},bodyBackground:"#111",viewBackground:"black",isCapturing:!1,isCapturingGameCanvasOnly:!1,isSoundEnabled:!0,captureCanvasScale:1,theme:{name:"simple",isUsingPixi:!1,isDarkColor:!1},colorPalette:void 0};let ae,Mi=10,Il;function Hn(e,l,i){ki=e,Pi=l,ae=Object.assign(Object.assign({},_n),i),M(ae.theme.isDarkColor,ae.colorPalette),un(ae.viewSize,ae.bodyBackground,ae.viewBackground,ae.isCapturing,ae.isCapturingGameCanvasOnly,ae.captureCanvasScale,ae.captureDurationSec,ae.theme),pi(()=>{oe.resume()}),xn(),ki(),Ii()}function Ii(){Il=requestAnimationFrame(Ii);const e=window.performance.now();e<al-Ri/12||(al+=bt,(al<e||al>e+bt*2)&&(al=e+bt),Ct&&Dn(),ae.isSoundEnabled&&sss.update(),mi(),Pi(),ae.isCapturing&&hn(),Mi--,Mi===0&&Cn())}function Gn(){Il&&(cancelAnimationFrame(Il),Il=void 0)}let Tl;const Ol=new Ml;function kt(){Tl=[]}function Ti(e,l=16,i=1,n=0,a=Math.PI*2,f=void 0){if(l<1){if(Ol.get()>l)return;l=1}for(let C=0;C<l;C++){const k=n+Ol.get(a)-a/2,P={pos:new o(e),vel:new o(i*Ol.get(.5,1),0).rotate(k),color:se,ticks:u(Ol.get(10,20)*Math.sqrt(Math.abs(i)),10,60),edgeColor:f};Tl.push(P)}}function Al(){vl(),Tl=Tl.filter(e=>{if(e.ticks--,e.ticks<0)return!1;e.pos.add(e.vel),e.vel.mul(.98);const l=Math.floor(e.pos.x),i=Math.floor(e.pos.y);return e.edgeColor!=null&&(me(e.edgeColor),_e(l-1,i-1,3,3)),me(e.color),_e(l,i,1,1),!0}),Cl()}function Pt(e,l,i,n){return Oi(!1,e,l,i,n)}function Xn(e,l,i,n){return Oi(!0,e,l,i,n)}function qn(e,l,i,n,a=.5,f=.5){typeof e!="number"&&(f=a,a=n,n=i,i=l,l=e.y,e=e.x);const C=new o(i).rotate(a),k=new o(e-C.x*f,l-C.y*f);return Rt(k,C,n)}function Jn(e,l,i=3,n=3,a=3){const f=new o,C=new o;if(typeof e=="number")if(typeof l=="number")typeof i=="number"?(f.set(e,l),C.set(i,n)):(f.set(e,l),C.set(i),a=n);else throw"invalid params";else if(typeof l=="number")if(typeof i=="number")f.set(e),C.set(l,i),a=n;else throw"invalid params";else if(typeof i=="number")f.set(e),C.set(l),a=i;else throw"invalid params";return Rt(f,C.sub(f),a)}function Kn(e,l,i,n,a,f){let C=new o;typeof e=="number"?C.set(e,l):(C.set(e),f=a,a=n,n=i,i=l),n==null&&(n=3),a==null&&(a=0),f==null&&(f=Math.PI*2);let k,P;if(a>f?(k=f,P=a-f):(k=a,P=f-a),P=u(P,0,Math.PI*2),P<.01)return;const O=u(Math.ceil(P*Math.sqrt(i*.25)),1,36),N=P/O;let j=k,E=new o(i).rotate(j).add(C),_=new o,Q=new o,Z={isColliding:{rect:{},text:{},char:{}}};for(let ie=0;ie<O;ie++){j+=N,_.set(i).rotate(j).add(C),Q.set(_).sub(E);const te=Rt(E,Q,n,!0);Z=Object.assign(Object.assign(Object.assign({},Z),et(te.isColliding.rect)),{isColliding:{rect:Object.assign(Object.assign({},Z.isColliding.rect),te.isColliding.rect),text:Object.assign(Object.assign({},Z.isColliding.text),te.isColliding.text),char:Object.assign(Object.assign({},Z.isColliding.char),te.isColliding.char)}}),E.set(_)}return Qt(),Z}function Oi(e,l,i,n,a){if(typeof l=="number"){if(typeof i=="number")return typeof n=="number"?a==null?Ue(e,l,i,n,n):Ue(e,l,i,n,a):Ue(e,l,i,n.x,n.y);throw"invalid params"}else if(typeof i=="number"){if(n==null)return Ue(e,l.x,l.y,i,i);if(typeof n=="number")return Ue(e,l.x,l.y,i,n);throw"invalid params"}else return Ue(e,l.x,l.y,i.x,i.y)}function Rt(e,l,i,n=!1){let a=!0;(X.name==="shape"||X.name==="shapeDark")&&(se!=="transparent"&&dn(e.x,e.y,e.x+l.x,e.y+l.y,i),a=!1);const f=Math.floor(u(i,3,10)),C=Math.abs(l.x),k=Math.abs(l.y),P=u(Math.ceil(C>k?C/f:k/f)+1,3,99);l.div(P-1);let O={isColliding:{rect:{},text:{},char:{}}};for(let N=0;N<P;N++){const j=Ue(!0,e.x,e.y,i,i,!0,a);O=Object.assign(Object.assign(Object.assign({},O),et(j.isColliding.rect)),{isColliding:{rect:Object.assign(Object.assign({},O.isColliding.rect),j.isColliding.rect),text:Object.assign(Object.assign({},O.isColliding.text),j.isColliding.text),char:Object.assign(Object.assign({},O.isColliding.char),j.isColliding.char)}}),e.add(l)}return n||Qt(),O}function Ue(e,l,i,n,a,f=!1,C=!0){let k=C;(X.name==="shape"||X.name==="shapeDark")&&k&&se!=="transparent"&&(e?_e(l-n/2,i-a/2,n,a):_e(l,i,n,a),k=!1);let P=e?{x:Math.floor(l-n/2),y:Math.floor(i-a/2)}:{x:Math.floor(l),y:Math.floor(i)};const O={x:Math.trunc(n),y:Math.trunc(a)};if(O.x===0||O.y===0)return{isColliding:{rect:{},text:{},char:{}}};O.x<0&&(P.x+=O.x,O.x*=-1),O.y<0&&(P.y+=O.y,O.y*=-1);const N={pos:P,size:O,collision:{isColliding:{rect:{}}}};N.collision.isColliding.rect[se]=!0;const j=Zt(N);return se!=="transparent"&&((f?Sl:He).push(N),k&&_e(P.x,P.y,O.x,O.y)),j}function Mt({pos:e,size:l,text:i,isToggle:n=!1,onClick:a=()=>{},isSmallText:f=!0}){return{pos:e,size:l,text:i,isToggle:n,onClick:a,isPressed:!1,isSelected:!1,isHovered:!1,toggleGroup:[],isSmallText:f}}function It(e){const l=new o(Me).sub(e.pos);e.isHovered=l.isInRect(0,0,e.size.x,e.size.y),e.isHovered&&Je&&(e.isPressed=!0),e.isPressed&&!e.isHovered&&(e.isPressed=!1),e.isPressed&&tl&&(e.onClick(),e.isPressed=!1,e.isToggle&&(e.toggleGroup.length===0?e.isSelected=!e.isSelected:(e.toggleGroup.forEach(i=>{i.isSelected=!1}),e.isSelected=!0))),Dl(e)}function Dl(e){vl(),me(e.isPressed?"blue":"light_blue"),Pt(e.pos.x,e.pos.y,e.size.x,e.size.y),e.isToggle&&!e.isSelected&&(me("white"),Pt(e.pos.x+1,e.pos.y+1,e.size.x-2,e.size.y-2)),me(e.isHovered?"black":"blue"),ei(e.text,e.pos.x+3,e.pos.y+3,{isSmallText:e.isSmallText}),Cl()}let xe,cl,Le,Tt;function Vn(e){xe={randomSeed:e,inputs:[]}}function Wn(e){xe.inputs.push(e)}function Ai(){return xe!=null}function Yn(e){cl=0,e.setSeed(xe.randomSeed)}function Qn(){cl>=xe.inputs.length||(rl(xe.inputs[cl]),cl++)}function Zn(){Le=[]}function es(e,l,i){Le.push({randomState:i.getState(),gameState:cloneDeep(e),baseState:cloneDeep(l)})}function ls(e){const l=Le.pop(),i=l.randomState;return e.setSeed(i.w,i.x,i.y,i.z,0),Tt={pos:new o(Me),isPressed:Ie,isJustPressed:we,isJustReleased:Ae},rl(xe.inputs.pop()),l}function ts(e){const l=Le[Le.length-1],i=l.randomState;return e.setSeed(i.w,i.x,i.y,i.z,0),Tt={pos:new o(Me),isPressed:Ie,isJustPressed:we,isJustReleased:Ae},rl(xe.inputs[xe.inputs.length-1]),l}function is(){rl(Tt)}function ns(){return Le.length===0}function ss(){const e=cl-1;if(!(e>=xe.inputs.length))return Le[e]}const Ot=4,rs=60,os="video/webm;codecs=vp8,opus",as="video/webm",cs="recording.webm",us=1e5*Ot,ds=.7;let ge,Fl;function fs(e,l,i){if(ge!=null)return;const n=document.createElement("canvas");n.width=e.width*Ot,n.height=e.height*Ot;const a=n.getContext("2d");a.imageSmoothingEnabled=!1;const f=()=>{a.drawImage(e,0,0,e.width,e.height,0,0,n.width,n.height),Fl=requestAnimationFrame(f)};f();const C=n.captureStream(rs),k=l.createMediaStreamDestination(),P=l.createGain();P.gain.value=ds,i.forEach(E=>{E!=null&&E.connect(P)}),P.connect(k);const O=k.stream,N=new MediaStream([...C.getVideoTracks(),...O.getAudioTracks()]);ge=new MediaRecorder(N,{mimeType:os,videoBitsPerSecond:us});let j=[];ge.ondataavailable=E=>{E.data.size>0&&j.push(E.data)},ge.onstop=()=>{const E=new Blob(j,{type:as}),_=URL.createObjectURL(E),Q=document.createElement("a");Q.href=_,Q.download=cs,Q.click(),URL.revokeObjectURL(_),j=[]},ge.start()}function hs(){ge!=null&&ge.state!=="inactive"&&(ge.stop(),ge=void 0),Fl&&(cancelAnimationFrame(Fl),Fl=void 0)}function gs(){return ge!=null&&ge.state==="recording"}const ps=Math.PI,ms=Math.abs,ys=Math.sin,ws=Math.cos,xs=Math.atan2,vs=Math.sqrt,Cs=Math.pow,Ss=Math.floor,bs=Math.round,ks=Math.ceil;t.ticks=0,t.difficulty=void 0,t.score=0,t.time=void 0,t.isReplaying=!1;function Ps(e=1,l){return Oe.get(e,l)}function Rs(e=2,l){return Oe.getInt(e,l)}function Ms(e=1,l){return Oe.get(e,l)*Oe.getPlusOrMinus()}function At(e="GAME OVER"){Ll=e,S.isShowingTime&&(t.time=void 0),Ni()}function Is(e="COMPLETE"){Ll=e,Ni()}function Ts(e,l,i){if(t.isReplaying||(t.score+=e,l==null))return;const n=`${e>=1?"+":""}${Math.floor(e)}`;let a=new o;typeof l=="number"?a.set(l,i):a.set(l),a.x-=n.length*(S.isUsingSmallText?Ge:ee)/2,a.y-=ee/2,jl.push({str:n,pos:a,vy:-2,ticks:30})}function Di(e){me(e)}function Os(e,l,i,n,a,f){let C=new o;typeof e=="number"?(C.set(e,l),k(C,i,n,a,f)):(C.set(e),k(C,l,i,n,a));function k(P,O,N,j,E){if(Ks(O)){const _=O;Ti(P,_.count,_.speed,_.angle,_.angleWidth,_.edgeColor)}else Ti(P,O,N,j,E)}}function Fi(e,l){return new o(e,l)}function Ei(e,l){!fl&&!Ne&&(Ct&&vi(e,l!=null&&l.volume!=null?l.volume:1)||(S.isSoundEnabled&&typeof sss.playSoundEffect=="function"?sss.playSoundEffect(e,l):S.isSoundEnabled&&sss.play(Fs[e])))}let Dt;function Ft(){Ut&&vi(S.bgmName,S.bgmVolume)||(typeof sss.generateMml=="function"?Dt=sss.playMml(sss.generateMml(),{volume:S.bgmVolume}):sss.playBgm())}function Et(){Ut?Ci(S.bgmName):Dt!=null?sss.stopMml(Dt):sss.stopBgm()}function zi(){fs(H,oe,[ol,Nl])}function zt(){hs()}function As(e){if(fl){const l=ts(Oe),i=l.baseState;return t.score=i.score,t.ticks=i.ticks,cloneDeep(l.gameState)}else if(Ne){const l=ls(Oe),i=l.baseState;return t.score=i.score,t.ticks=i.ticks,l.gameState}else{if(t.isReplaying)return ss().gameState;if($e==="inGame"){const l={score:t.score,ticks:t.ticks};es(e,l,Oe)}}return e}function Ds(){Ne||(!t.isReplaying&&S.isRewindEnabled?Hs():At())}const Fs={coin:"c",laser:"l",explosion:"e",powerUp:"p",hit:"h",jump:"j",select:"s",lucky:"u",random:"r",click:"i",synth:"y",tone:"t"},ji={isPlayingBgm:!1,isCapturing:!1,isCapturingGameCanvasOnly:!1,captureCanvasScale:1,captureDurationSec:5,isShowingScore:!0,isShowingTime:!1,isReplayEnabled:!1,isRewindEnabled:!1,isDrawingParticleFront:!1,isDrawingScoreFront:!1,isUsingSmallText:!0,isMinifying:!1,isSoundEnabled:!0,viewSize:{x:100,y:100},audioSeed:0,seed:0,audioVolume:1,theme:"simple",colorPalette:void 0,textEdgeColor:{score:void 0,floatingScore:void 0,title:void 0,description:void 0,gameOver:void 0},bgmName:"bgm",bgmVolume:1,audioTempo:120,isRecording:!1},Es=new Ml,Oe=new Ml;let $e,zs={title:Bs,inGame:Ns,gameOver:_s,rewind:Gs},ul=0,El,zl=!0,dl=0,S,Ui,jl,fl=!1,Ne=!1,hl,Ul,Ll,jt,$l,Nl,Ut=!1;function js(e){window.update=e.update,window.title=e.title,window.description=e.description,window.characters=e.characters,window.options=e.options,window.audioFiles=e.audioFiles,Li()}function Li(){typeof options<"u"&&options!=null?S=Object.assign(Object.assign({},ji),options):S=ji;const e={name:S.theme,isUsingPixi:!1,isDarkColor:!1};S.theme!=="simple"&&S.theme!=="dark"&&(e.isUsingPixi=!0),(S.theme==="pixel"||S.theme==="shapeDark"||S.theme==="crt"||S.theme==="dark")&&(e.isDarkColor=!0),dl=S.audioSeed+S.seed,S.isMinifying&&Ws(),Ui={viewSize:S.viewSize,bodyBackground:e.isDarkColor?"#101010":"#e0e0e0",viewBackground:e.isDarkColor?"blue":"white",theme:e,isSoundEnabled:S.isSoundEnabled,isCapturing:S.isCapturing,isCapturingGameCanvasOnly:S.isCapturingGameCanvasOnly,captureCanvasScale:S.captureCanvasScale,captureDurationSec:S.captureDurationSec,colorPalette:S.colorPalette},Hn(Ls,$s,Ui)}function Us(){Gn(),zt(),Fn(),window.update=void 0,window.title=void 0,window.description=void 0,window.characters=void 0,window.options=void 0,window.audioFiles=void 0}function Ls(){if(typeof description<"u"&&description!=null&&description.trim().length>0&&(zl=!1,dl+=Xi(description)),typeof title<"u"&&title!=null&&title.trim().length>0&&(zl=!1,document.title=title,dl+=Xi(title),$l=`crisp-game-${encodeURIComponent(title)}-${dl}`,ul=Js()),typeof characters<"u"&&characters!=null&&vn(characters,"a"),En(),typeof audioFiles<"u"&&audioFiles!=null){zn(),bi(.1*S.audioVolume),Si(S.audioTempo);for(let e in audioFiles){const l=jn(e,audioFiles[e]);e===S.bgmName&&(l.isLooping=!0,Ut=!0)}}S.isSoundEnabled&&(Nl=oe.createGain(),Nl.connect(oe.destination),sss.init(dl,oe,Nl),sss.setVolume(.1*S.audioVolume),sss.setTempo(S.audioTempo)),me("black"),zl?(Lt(),t.ticks=0):$i()}function $s(){t.df=t.difficulty=t.ticks/3600+1,t.tc=t.ticks;const e=t.score,l=t.time;t.sc=t.score;const i=t.sc;t.inp={p:Me,ip:Ie,ijp:we,ijr:Ae},pn(),zs[$e](),X.isUsingPixi&&(xl(),X.name==="crt"&&fn()),t.ticks++,t.isReplaying?(t.score=e,t.time=l):t.sc!==i&&(t.score=t.sc)}function Lt(){$e="inGame",t.ticks=-1,kt();const e=Math.floor(t.score);e>ul&&(ul=e),S.isShowingTime&&t.time!=null&&(El==null||El>t.time)&&(El=t.time),t.score=0,t.time=0,jl=[],S.isPlayingBgm&&S.isSoundEnabled&&Ft();const l=Es.getInt(999999999);Oe.setSeed(l),(S.isReplayEnabled||S.isRewindEnabled)&&(Vn(l),Zn(),t.isReplaying=!1)}function Ns(){yl(),S.isDrawingParticleFront||Al(),S.isDrawingScoreFront||Gi(),(S.isReplayEnabled||S.isRewindEnabled)&&Wn({pos:Fi(Me),isPressed:Ie,isJustPressed:we,isJustReleased:Ae}),typeof update=="function"&&update(),S.isDrawingParticleFront&&Al(),S.isDrawingScoreFront&&Gi(),$t(),S.isShowingTime&&t.time!=null&&t.time++,S.isRecording&&!gs()&&zi()}function $i(){$e="title",t.ticks=-1,kt(),yl(),Ai()&&(Yn(Oe),t.isReplaying=!0)}function Bs(){if(we){Lt();return}if(yl(),S.isReplayEnabled&&Ai()&&(Qn(),t.inp={p:Me,ip:Ie,ijp:we,ijr:Ae},S.isDrawingParticleFront||Al(),update(),S.isDrawingParticleFront&&Al()),$t(),typeof title<"u"&&title!=null){let e=0;title.split(`
`).forEach(i=>{i.length>e&&(e=i.length)});const l=Math.floor(($.x-e*ee)/2);title.split(`
`).forEach((i,n)=>{ke(i,l,Math.floor($.y*.25)+n*ee,{edgeColor:S.textEdgeColor.title})})}if(typeof description<"u"&&description!=null){let e=0;description.split(`
`).forEach(n=>{n.length>e&&(e=n.length)});const l=S.isUsingSmallText?Ge:ee,i=Math.floor(($.x-e*l)/2);description.split(`
`).forEach((n,a)=>{ke(n,i,Math.floor($.y/2)+a*ee,{isSmallText:S.isUsingSmallText,edgeColor:S.textEdgeColor.description})})}}function Ni(){$e="gameOver",t.isReplaying||yi(),t.ticks=-1,_i(),S.isPlayingBgm&&S.isSoundEnabled&&Et();const e=Math.floor(t.score);e>ul&&qs(e)}function _s(){t.ticks===0&&!X.isUsingPixi&&_i(),(t.isReplaying||t.ticks>20)&&we?(Bi(),Lt()):t.ticks===(S.isReplayEnabled?120:300)&&!zl&&(Bi(),$i())}function Bi(){!S.isRecording||t.isReplaying||zt()}function _i(){t.isReplaying||ke(Ll,Math.floor(($.x-Ll.length*ee)/2),Math.floor($.y/2),{edgeColor:S.textEdgeColor.gameOver})}function Hs(){$e="rewind",fl=!0,hl=Mt({pos:{x:$.x-39,y:11},size:{x:36,y:7},text:"Rewind",isSmallText:S.isUsingSmallText}),Ul=Mt({pos:{x:$.x-39,y:$.y-19},size:{x:36,y:7},text:"GiveUp",isSmallText:S.isUsingSmallText}),S.isPlayingBgm&&S.isSoundEnabled&&Et(),X.isUsingPixi&&(Dl(hl),Dl(Ul))}function Gs(){yl(),update(),$t(),is(),Ne?(Dl(hl),(ns()||!Ie)&&Xs()):(It(hl),It(Ul),hl.isPressed&&(Ne=!0,fl=!1)),Ul.isPressed&&(fl=Ne=!1,At()),S.isShowingTime&&t.time!=null&&t.time++}function Xs(){Ne=!1,$e="inGame",kt(),S.isPlayingBgm&&S.isSoundEnabled&&Ft()}function $t(){if(S.isShowingTime)Hi(t.time,3,3),Hi(El,$.x-7*(S.isUsingSmallText?Ge:ee),3);else if(S.isShowingScore){ke(`${Math.floor(t.score)}`,3,3,{isSmallText:S.isUsingSmallText,edgeColor:S.textEdgeColor.score});const e=`HI ${ul}`;ke(e,$.x-e.length*(S.isUsingSmallText?Ge:ee),3,{isSmallText:S.isUsingSmallText,edgeColor:S.textEdgeColor.score})}}function Hi(e,l,i){if(e==null)return;let n=Math.floor(e*100/50);n>=10*60*100&&(n=10*60*100-1);const a=Nt(Math.floor(n/6e3),1)+"'"+Nt(Math.floor(n%6e3/100),2)+'"'+Nt(Math.floor(n%100),2);ke(a,l,i,{isSmallText:S.isUsingSmallText,edgeColor:S.textEdgeColor.score})}function Nt(e,l){return("0000"+e).slice(-l)}function Gi(){vl(),me("black"),jl=jl.filter(e=>(ke(e.str,e.pos.x,e.pos.y,{isSmallText:S.isUsingSmallText,edgeColor:S.textEdgeColor.floatingScore}),e.pos.y+=e.vy,e.vy*=.9,e.ticks--,e.ticks>0)),Cl()}function Xi(e){let l=0;for(let i=0;i<e.length;i++){const n=e.charCodeAt(i);l=(l<<5)-l+n,l|=0}return l}function qs(e){if($l!=null)try{const l={highScore:e};localStorage.setItem($l,JSON.stringify(l))}catch(l){console.warn("Unable to save high score:",l)}}function Js(){try{const e=localStorage.getItem($l);if(e)return JSON.parse(e).highScore}catch(e){console.warn("Unable to load high score:",e)}return 0}function Ks(e){return e!=null&&e.constructor===Object}function Vs(){let e=window.location.search.substring(1);if(e=e.replace(/[^A-Za-z0-9_-]/g,""),e.length===0)return;const l=document.createElement("script");jt=`${e}/main.js`,l.setAttribute("src",jt),document.head.appendChild(l)}function Ws(){fetch(jt).then(e=>e.text()).then(e=>{const l=Terser.minify(e+"update();",{toplevel:!0}).code,i="function(){",n=l.indexOf(i),a="options={",f=l.indexOf(a);let C=l;if(n>=0)C=l.substring(l.indexOf(i)+i.length,l.length-4);else if(f>=0){let k=1,P;for(let O=f+a.length;O<l.length;O++){const N=l.charAt(O);if(N==="{")k++;else if(N==="}"&&(k--,k===0)){P=O+2;break}}k===0&&(C=l.substring(P))}qi.forEach(([k,P])=>{C=C.split(k).join(P)}),console.log(C),console.log(`${C.length} letters`)})}t.inp=void 0;function Ys(...e){return Di.apply(this,e)}function Qs(...e){return Ei.apply(this,e)}function Zs(...e){return w.apply(this,e)}function er(...e){return p.apply(this.args)}t.tc=void 0,t.df=void 0,t.sc=void 0;const lr="transparent",tr="white",ir="red",nr="green",sr="yellow",rr="blue",or="purple",ar="cyan",cr="black",ur="coin",dr="laser",fr="explosion",hr="powerUp",gr="hit",pr="jump",mr="select",yr="lucky";let qi=[["===","=="],["!==","!="],["input.pos","inp.p"],["input.isPressed","inp.ip"],["input.isJustPressed","inp.ijp"],["input.isJustReleased","inp.ijr"],["color(","clr("],["play(","ply("],["times(","tms("],["remove(","rmv("],["ticks","tc"],["difficulty","df"],["score","sc"],[".isColliding.rect.transparent",".tr"],[".isColliding.rect.white",".wh"],[".isColliding.rect.red",".rd"],[".isColliding.rect.green",".gr"],[".isColliding.rect.yellow",".yl"],[".isColliding.rect.blue",".bl"],[".isColliding.rect.purple",".pr"],[".isColliding.rect.cyan",".cy"],[".isColliding.rect.black",".lc"],['"transparent"',"tr"],['"white"',"wh"],['"red"',"rd"],['"green"',"gr"],['"yellow"',"yl"],['"blue"',"bl"],['"purple"',"pr"],['"cyan"',"cy"],['"black"',"lc"],['"coin"',"cn"],['"laser"',"ls"],['"explosion"',"ex"],['"powerUp"',"pw"],['"hit"',"ht"],['"jump"',"jm"],['"select"',"sl"],['"lucky"',"uc"]];t.PI=ps,t.abs=ms,t.addGameScript=Vs,t.addScore=Ts,t.addWithCharCode=d,t.arc=Kn,t.atan2=xs,t.bar=qn,t.bl=rr,t.box=Xn,t.ceil=ks,t.char=yn,t.clamp=u,t.clr=Ys,t.cn=ur,t.color=Di,t.complete=Is,t.cos=ws,t.cy=ar,t.end=At,t.ex=fr,t.floor=Ss,t.frameState=As,t.getButton=Mt,t.gr=nr,t.ht=gr,t.init=js,t.input=An,t.jm=pr,t.keyboard=Rn,t.lc=cr,t.line=Jn,t.ls=dr,t.minifyReplaces=qi,t.onLoad=Li,t.onUnload=Us,t.particle=Os,t.play=Ei,t.playBgm=Ft,t.ply=Qs,t.pointer=On,t.pow=Cs,t.pr=or,t.pw=hr,t.range=y,t.rd=ir,t.rect=Pt,t.remove=p,t.rewind=Ds,t.rmv=er,t.rnd=Ps,t.rndi=Rs,t.rnds=Ms,t.round=bs,t.sin=ys,t.sl=mr,t.sqrt=vs,t.startRecording=zi,t.stopBgm=Et,t.stopRecording=zt,t.text=ei,t.times=w,t.tms=Zs,t.tr=lr,t.uc=yr,t.updateButton=It,t.vec=Fi,t.wh=tr,t.wrap=r,t.yl=sr}(window||{})),Ji}Sr();const br=[`
  l
 lll
lllll
l l l
